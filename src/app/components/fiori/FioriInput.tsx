...
interface FioriInputProps extends InputHTMLAttributes<HTMLInputElement> {
  label?: string;
  error?: string;
  fullWidth?: boolean;
}

export function FioriInput({ label, error, fullWidth = false, className = '', ...props }: FioriInputProps) {
  return (
